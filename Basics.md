...
<!-- #region editable=true jp-MarkdownHeadingCollapsed=true slideshow={"slide_type": "notes"} -->
...
<!-- #region editable=true raw_mimetype="" slideshow={"slide_type": "notes"} -->
...
<!-- #region editable=true slideshow={"slide_type": null} -->
### _<ins>Examples:</ins>_
<!-- #endregion -->
